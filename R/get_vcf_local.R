#' Get data for a genomic region from a local VCF file.
#' 
#' Returns a list with three dataframes for individuals, SNPs, and genotypes.
#' 
#' Currently, this is hard-coded to access a local copy of 1000 Genomes phase3 data by
...
#' @examples
#' vcf <- get_vcf_local(chrom = "12", start = 533090, end = 623090, pop = "AFR",fDir = NA)
#' names(vcf)
#'  
#' @export     
get_vcf_local <- function(chrom, start, end, pop = NA, fDir) {
